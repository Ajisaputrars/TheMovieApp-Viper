...
public class Utils {
  public static func changeDateStringIntoFormattedString(
    withStringDate dateString: String, locale: String = "id_ID"
  ) -> String {
  ...
  public static func showAlert(in controller: UIViewController, title: String, message: String) {
